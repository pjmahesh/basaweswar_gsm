...
#ifdef GW1
#define API_KEY1 "WIHFMNOJL9N1IEF3" // gw1 - Basaweswar 1
#define API_KEY2 "9CA4D7E8XHHAUSUK" //gw1 - Basaweswar 2
#define API_KEY3 "G9GN6DPKSD6WY5W9" //gw1 - Basaweswar 3
#define API_KEY4 "DOXD0G6DASI9TCUY"// gw1 - Basaweswar 4
#else
#define API_KEY1 "UYZRAABMDYRB77VF" //gw2 - Basaweswar 5
#define API_KEY2 "JTO60JQX1V2OQVH7" //gw2 - Basaweswar 6
#define API_KEY3 "K3CIAFCOANKYV46T" //gw2 - Basaweswar 7
#define API_KEY4 "HTG9RUFHQMKDMG86" //gw2 - Basaweswar 8
#endif
...
void setup()
{
  ...
  Serial.println(F("Setup Dec11 8:55pm"));
